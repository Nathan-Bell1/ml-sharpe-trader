...
def run_data_analysis():
    ...
    if os.name == 'nt': 
        python_exec = os.path.join("yfinance_env", "Scripts", "python.exe")
    else:  
...
def run_trading():
    ...
    if os.name == 'nt': 
        python_exec = os.path.join("alpaca_env", "Scripts", "python.exe")
    else:
...
2. Install packages:
   # In yfinance_env:
   pip install yfinance pandas scikit-learn lxml
